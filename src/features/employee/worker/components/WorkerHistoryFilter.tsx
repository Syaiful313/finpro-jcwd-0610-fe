...
interface WorkerHistoryFiltersProps {
  onApply: (filters: {
...
const WorkerHistoryFilters: React.FC<WorkerHistoryFiltersProps> = ({
  onApply,
  onClear,
  isPending,
}) => {
      ...
      <div className="space-y-2">
        ...
        >
          <SelectTrigger className="w-full">
            <SelectValue>
              {WORKER_TYPES.find((type) => type.value === localWorkerType)
...
export default WorkerHistoryFilters;

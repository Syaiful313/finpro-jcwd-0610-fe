...
const ListOfBypass = () => {
  ...
  return (
    <div>
      ...
      {isPending ? (
        <div className="p-4 text-center">Loading bypass requests...</div>
      ) : isError ? (
        ...
        <div className="p-3 md:p-6">
          {bypassData?.data?.length > 0 ? (
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              {bypassData.data.map((request) => {
                ...
                if (bypassedStation === "washing") {
                  ...
                  isActionable = associatedOrder.orderStatus === "BEING_WASHED";
                } else if (bypassedStation === "packing") {
                      ...
                      <div className="space-y-1.5">
                        ...
                        {request.bypassStatus === "APPROVED" && (
                          <p className="flex items-center justify-center gap-1 text-xs text-green-600">
                            <Info className="h-3 w-3" />
                            Approved. Find this order in the Station Queue to
                            proceed.
                          </p>
                        )}
                      </div>
            ...
            <div className="p-4 text-center">
              No bypass requests found for the selected filters.
            </div>
          )}
